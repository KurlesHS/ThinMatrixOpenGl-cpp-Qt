...
RawModelSharedPtr Loader::loadDataToVao(const QVector<GLfloat> &positions, const QVector<GLfloat> &normals, const QVector<GLfloat> &textureCoords, const QVector<GLint> &indices)
{
    int vaoId = createVao();
